...
export function AddTranSMonthFDayForm(props: IProps) {
  const months = [
    "Enero",
    "Febrero",
    "Marzo",
  ...
  const daySelection = days.map((day) => {
        ...
        return (
          <Form>
            <Stack spacing={3}>
              ...
              <FormControl
                isInvalid={
                  formProps.errors.day !== undefined &&
                  formProps.touched.day
                }
              >
                <FormLabel htmlFor="day">Día de Cada Mes</FormLabel>
                <RadioGroup>
                  <Stack direction="row" spacing={2}>
                    <Field name="day">
                      {({ field, form }: FieldProps<any, IInitialValues>) => {
                        return (
                          <Select placeholder="Escoja un día">
                            {daySelection}
                          </Select>
                        );
                      }}
                ...
                <FormErrorMessage>{formProps.errors.day}</FormErrorMessage>
              </FormControl>
              <FormControl
                isInvalid={
